...
1. **Site or issue** — Use the **Propose a use case** panel on the live map (stays on-page; a small Cloudflare Worker creates the labeled GitHub issue). Or open the [Propose use case](https://github.com/galigutta/jev-use-cases/issues/new?template=propose_use_case.yml) issue form manually.
